...
document.getElementById("5-min-btn").addEventListener("click", initFiveMinute);
document.getElementById("10-min-btn").addEventListener("click", initTenMinute);
document.getElementById("15-min-btn").addEventListener("click", initFifteenMinute);
document.getElementById("30-min-btn").addEventListener("click", initThirtyMinute);
document.getElementById("1-hr-btn").addEventListener("click", initSixtyMinute);
